...
<div class="snippet-clipboard-content notranslate position-relative overflow-auto" data-snippet-clipboard-copy-content="sudo pip3 install -r requirments.txt"><pre class="notranslate"><code>sudo pip3 install -r requirments.txt</code></pre></div>
